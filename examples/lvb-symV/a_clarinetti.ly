...
clarinetti = {
  ...
  \repeat volta 2 {
    ...
    R2 R2 R2 \crescTextCresc <d'' f''>2\<~ <d'' f''>~ <d'' f''> <c'' f''>~ <c'' f''> <b' f''>~ <b' f''>~ <b' f''>~ <b' f''>~ <b' f''>4 <b' f''>
    <b' f''>4 <b' f''>\!
  ...
  R2 r8 <<
    { ees''8[ ees'' ees''] d''2~ d''2~ d''2~ d''8 ees''8[ ees'' ees''] d''2~ d''2~ d''2 d''2~ d''2~ d''2~ d''2~ d''4 } \\
    { ees''8\p[ ees'' ees''] d''2~ d''2~ d''2~ d''8 ees''8[ ees'' ees''] d''2~ d''2~ d''2 bes'2( a'2 bes'2 a'2 bes'4) }
  >> r4
  ...
  << { d''4( e'' d'' cis'') } \\ { R2 R2 } >> R2 R2 R2 R2 R2 \crescTextCresc <bes' bes''>4\<( <a' a''> <g' g''> <a' a''>)
  ...
  <<
    ...
    { R2 R2 R2 R2 R2 R2 R2 e'8\rest }
  >> <cis'' e''>8\ff[ <cis'' e''> <cis'' e''>] <d'' f''>4 r
