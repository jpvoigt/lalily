...
fagotti = {
  ...
  \repeat volta 2 {
    ...
    <<
      ...
      { c'2\p~ c'~ c'~ c' b~ b~ b~ b c' b c' b8_\markup { \italic "cresc." }[ b b b] c'4\f  }
    >> r4
    ...
    \crescTextCresc <a, a>2\<~ <a, a> <bes, bes>~ <bes, bes> <ces ces'>~ <ces ces'>
  ...
  r8 <<
    { ees'8[ ees' d'] c'[ c' c' bes] a s8 s4 } \\
    { \crescTextCresc ees'8\<[ ees' d'] c'[ c' c' bes\!] a8\p[ <fis d'> <fis d'> <a c'>] }
  >> <g bes>2
  <fis a>8[ <fis d'> <fis d'> <a c'>] <g b>2 <fis a> <g b>4 r4
  \clef bass <<
    {
      a8\rest g8[ a bes] c'4 a4\rest a8\rest fis8[ a bes] c'4 a4\rest a8\rest a8[ bes c']
      d'4 a4\rest a8\rest g8[ bes c'] d'4 a4\rest
    } \\ { g,2:8 a,2~ a,2:8 a,2~ a,2:8 bes,2~ bes,2:8 bes,2 }
  >>
  ...
  \crescTextCresc <aes,! aes>2\<~ <aes, aes>2~ <aes, aes>2 <b, b>2~ <b, b>2\!
  \crescTextCresc <d d'>2\<~ <d d'>2~ <d d'>2~ <d d'>2 <d d'>2~ <d d'> <d d'>2~ <d d'>~ <d d'>2~ <d d'>\!
  ...
  \clef tenor <<
    { e'4\rest g'4\p( ees'2)~ ees'2~ ees'2~ ees'4 g'4( ees'2)~ ees'2~ ees'2~ ees'8 } \\
    { R2 R2 R2 R2 R2 R2 R2 R2 d8\rest }
  >> <b d'>8[ <b d'> <b d'>] <c' ees'>4 r r8 <b d'>[ <b d'> <b d'>] <c' ees'>4 r
