...
violinotwo = {
  ...
  \repeat volta 2 {
    ...
    \crescTextCresc f'2\<~ f'8[ aes' aes' f'] g'2~ g'8[ g' g' ees'] aes'8\!\sf[ aes' aes' f']
    ...
    ees'4( f' \crescTextCresc ges'\< f' ees' f') ges'( f' ees' f') ges'( f' ees' f') ges'( f' ees' f' ges' f' ges' a'\!)
  ...
  g'2~ g'8[ ees' ees' f'] g'2~ \crescTextCresc g'2\<( a'4 bes' c'' cis'') d''2\!\p~ d''8[ g' g' a'] fis'4 r
  ...
  f'4( g' \crescTextCresc aes'!\< g' f' g') aes'( g' f' g') aes'4( g' f' g')
